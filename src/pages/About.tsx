...
const About = () => {
  ...
  return (
    ...
    className="overflow-y-hidden">
      <h1 className={` ${getCurrTheme() == 9  ? "title-font-lobster" : "title-font"} text-[110px] max-[500px]:text-[85px] text-rare-color text-center mt-16 font-bold`}>
        Hey <span className="max-[500px]:hidden font-bold">there.</span>
      </h1>
      <h1 className={` min-[500px]:hidden S${getCurrTheme() == 9  ? "title-font-lobster" : "title-font"} text-[110px] max-[500px]:text-[85px] text-rare-color text-center -mt-10 font-bold`}>
        there.
      </h1>
