    ...
    <div className=" border-t-[1px] border-fourth-color space-up p-8 max-[550px]:py-5 max-[550px]:px-2 w-full">
        <div className=" width text-white flex max-[520px]:flex-col max-[550px]:gap-5 justify-between items-center">
            ...
            <div className="flex gap-4">
                <a href="https://github.com/Mahmoudamin11" target="_blank" className={` text-2xl ${getCurrTheme() == 9 ? "cursor-lobsterHover" : "cursor-pointer"} trans hover:scale-105 text-text-color hover:text-sec-color`}>
                ...
                className={` text-2xl ${getCurrTheme() == 9 ? "cursor-lobsterHover" : "cursor-pointer"} trans hover:scale-105 text-text-color hover:text-sec-color`}>
